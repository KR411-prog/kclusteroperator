...
import (
	...
	radhav1 "github.com/KR411-prog/kluster/pkg/apis/radha/v1"
	versioned "github.com/KR411-prog/kluster/pkg/client/clientset/versioned"
	internalinterfaces "github.com/KR411-prog/kluster/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/KR411-prog/kluster/pkg/client/listers/radha/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.radhav1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.radhav1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&radhav1.Kluster{},
		resyncPeriod,
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&radhav1.Kluster{}, f.defaultInformer)
}
